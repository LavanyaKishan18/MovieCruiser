...
public class MovieItemDaoCollectionImpl implements MovieItemDao{
	...
	public MovieItemDaoCollectionImpl()
	{
		...
		movieItemList.add(new MovieItem(1,"Avatar",2356787934l,true,DateUtil.convertTodate("15/03/2017"),"Science Fiction",true));
		movieItemList.add(new MovieItem(2,"The Avengers",1518812988l,true,DateUtil.convertTodate("23/12/2017"),"Superhero",false));
		movieItemList.add(new MovieItem(3,"Titanic",2187463844l,true,DateUtil.convertTodate("21/08/2018"),"Romance",false));
		movieItemList.add(new MovieItem(4,"Jurrasic World",1671713208l,false,DateUtil.convertTodate("02/07/2017"),"Science Fiction",true));
		movieItemList.add(new MovieItem(5,"Avengers: Endgame",2750760348l,true,DateUtil.convertTodate("02/11/2022"),"Superhero",true));
			}
			catch(Exception e){
	...
	public List<MovieItem> getMovieItemListCustomer() {
		...
		if(movieItem.getDateOfLaunch().getTime()<=today.getTime()&&movieItem.isActive())
		{
			mpl.add(movieItem);
		}
		}
	...
	public void modifyMovieItem(MovieItem movieItem) {
        ...
        {
              if(movieItem.getId()==movieItem.getId())
